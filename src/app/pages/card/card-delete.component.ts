...
@Component({
  ...
  template: `
      ...
      <form nz-form [formGroup]="frm" [nzAutoTips]="autoTips">
        <nz-form-item>
          ...
          <nz-form-control [nzSm]="15" [nzXs]="24" nzErrorTip="">
            <input nz-input formControlName="cardNumber" />
          </nz-form-control>
        </nz-form-item>
    ...
    <div *nzModalFooter>
      <button
        *ngIf="!errMessage() && model?.cardNumber"
        nz-button
        nzDanger
        nzType="primary"
        [disabled]="!frm.valid"
...
export class CardDeleteComponent extends BaseDeleteComponent<Card> {
  constructor(
    service: CardService,
    uiService: CardUiService,
    ref: NzModalRef<CardDeleteComponent>,
    fb: FormBuilder
  ) {
  ...
  override initControl() {
    ...
    this.frm = this.fb.group({
      cardNumber: [{ value: null, disabled: true }, [required]],
