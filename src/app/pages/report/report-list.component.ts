import {Component, computed, input, OnChanges, SimpleChanges, ViewEncapsulation} from "@angular/core";
          ...
          <nz-content>
              ...
              >
                  ...
                  <tr>
                      ...
                      <th nzWidth="20%">{{ "DisplayName" | translate }}</th>
                      <th>{{ "Note" | translate }}</th>
                      <th nzWidth="200px"></th>
                  </tr>
                  </thead>
                  <tbody cdkDropList cdkDropListLockAxis="y"
                  ...
                  <tr *ngFor="let data of lists(); let i = index" cdkDrag>
                      ...
                      <td nzEllipsis>
                          <a *ngIf="isReportView"
                             (click)="uiService.showView(data.id || 0)">{{ data.name! | translate }}</a>
...
export class ReportListComponent extends BaseListComponent<Report> implements OnChanges {
  constructor(
