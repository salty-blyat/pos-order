...
@Component({
  selector: "app-agent-multi-select",
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => AgentMultiSelectComponent),
      multi: true,
    },
  ],
  template: `
    ...
    >
      <nz-option [nzValue]="0" [nzLabel]="'AllAgent' | translate"> </nz-option>
      <nz-option
...
export class AgentMultiSelectComponent
  extends BaseMultipleSelectComponent<Agent>
  implements OnInit, ControlValueAccessor, OnDestroy
{
  constructor(service: AgentService, translate: TranslateService) {
