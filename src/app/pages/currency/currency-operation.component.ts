  ...
  template: `
    ...
    <div class="modal-content">
      ...
      <form nz-form [formGroup]="frm" [nzAutoTips]="autoTips">
        ...
        <nz-form-item>
          <nz-form-label [nzSm]="6" [nzXs]="24" nzRequired nzFor="symbol"
            >{{ "Symbol" | translate }}
          </nz-form-label>
          <nz-form-control [nzSm]="17" [nzXs]="24" nzHasFeedback>
        ...
        <nz-form-item>
          <nz-form-label [nzSm]="6" [nzXs]="24" nzRequired nzFor="format"
            >{{ "Format" | translate }}
          </nz-form-label>
        ...
        <nz-form-item>
          <nz-form-label [nzSm]="6" [nzXs]="24" nzRequired nzFor="rounding"
            >{{ "Rounding" | translate }}
          </nz-form-label>
          <nz-form-control [nzSm]="17" [nzXs]="24">
        ...
        <nz-form-item>
          <nz-form-label [nzSm]="6" [nzXs]="24" nzRequired nzFor="exchangeRate"
