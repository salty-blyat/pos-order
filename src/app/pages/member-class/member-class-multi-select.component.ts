  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => MemberClassMultiSelectComponent),
      multi: true,
    },
  ],
  template: `
...
export class MemberClassMultiSelectComponent
  extends BaseMultipleSelectComponent<MemberClass>
  implements OnInit, ControlValueAccessor, OnDestroy
{
  constructor(service: MemberClassService, translate: TranslateService) {
