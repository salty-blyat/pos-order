...
export class UnitListComponent extends BaseListComponent<Unit> {
  ...
  isUnitAdd = computed<boolean>(() =>
    this.authService.isAuthorized(AuthKeys.APP__SETTING__UNIT__ADD)
  );
  isUnitEdit = computed<boolean>(() =>
    this.authService.isAuthorized(AuthKeys.APP__SETTING__UNIT__EDIT)
  );
  isUnitRemove = computed<boolean>(() =>
    this.authService.isAuthorized(AuthKeys.APP__SETTING__UNIT__REMOVE)
  );
  isUnitView = computed<boolean>(() =>
    this.authService.isAuthorized(AuthKeys.APP__SETTING__UNIT__VIEW)
  );
