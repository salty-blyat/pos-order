...
export class BuildingDeleteComponent extends BaseDeleteComponent<Building> {
  constructor(
    service: BuildingService,
    uiService: BuildingUiService,
    ref: NzModalRef<BuildingDeleteComponent>,
    fb: FormBuilder
  ) {
