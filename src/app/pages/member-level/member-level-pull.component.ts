import {
  ...
  @Component({
    selector: "app-member-level-pull",
    template: `
      <div *nzModalTitle>
        <span>{{ "MemberLevel" | translate }}</span>
      </div>
      <div class="modal-content">
        ...
        <span>{{ "PullMemberLevel" | translate }} !</span>
  ...
  export class MemberLevelPullComponent {
    constructor(
      private ref: NzModalRef<MemberLevelPullComponent>,
      private service: MemberLevelService,
    ...
    onSubmit(e: MouseEvent) {
      if (e.detail === 1 || e.detail === 0) {
        ...
        this.service.pull().subscribe({
          next: (result: { results: MemberLevel[]; summary: Summary }) => {
