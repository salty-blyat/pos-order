              ...
              <div nz-row>
                  ...
                  <div nz-col>
                      <app-item-type-select
                              ...
                              (valueChanged)="itemTypeId.set($event); param().pageIndex = 1; search()"
                      ></app-item-type-select>
                  </div>
              </div>
              <div>
          ...
          <nz-content>
              ...
              >
                  ...
                  <tr>
                      ...
                      <th  nzWidth="80px" nzAlign="center">{{ "IsTrackSerial" | translate }}</th>
                  ...
                  <tr *ngFor="let data of lists(); let i = index">
                      ...
                      <td nzEllipsis>
                          <a *ngIf="isItemView()" (click)="uiService.showView(data.id!)">{{ data.code }}</a>
